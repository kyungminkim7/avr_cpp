...
TEST(Construction, SetsFastPWMMode) {
    ...
    PulseWidthModulation0_1 pwm(PulseWidthModulation::Channel::B);
...
TEST(SetNonInvertingCompareOutputMode, One) {
    ...
    PulseWidthModulation2_8 pwm(PulseWidthModulation::Channel::A);
...
TEST(SetNonInvertingCompareOutputMode, Multiple) {
    ...
    PulseWidthModulation0_256 pwm(PulseWidthModulation::Channel::A | 
                                  PulseWidthModulation::Channel::B);
...
TEST(SetDutyCycle, OneChannel) {
    OCR2B = 0;
    PulseWidthModulation2_1024 pwm(PulseWidthModulation::Channel::B);
...
TEST(SetDutyCycle, MultipleChannels) {
    OCR0A = 0;
    OCR0B = 0;
    PulseWidthModulation0_1024 pwm(PulseWidthModulation::Channel::A |
                                   PulseWidthModulation::Channel::B);
...
TEST(SetDutyCycle, SelectChannel) {
    ...
    pwm.set(112, PulseWidthModulation::Channel::B);
...
TEST(StartSetsClockPrescaler, One) {
    ...
    PulseWidthModulation0_1 pwm(PulseWidthModulation::Channel::A);
    pwm.start();
...
TEST(Stop, ClearsClockSelectBits) {
    PulseWidthModulation2_1024 pwm(PulseWidthModulation::Channel::A);
    pwm.start();
